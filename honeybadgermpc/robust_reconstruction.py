...
def attempt_reconstruct(encoded, field, n, t, point, omega=None):
    ...
    _, decode, _ = makeEncoderDecoder(n, t+1, field.modulus, omega)
...
async def robust_reconstruct(field_futures, field, n, t, point, omega):
    ...
    for nAvailable in range(2*t + 1, n+1):
        try:
            ...
            P, failures = attempt_reconstruct(elems, field, n, t, point, omega)
            print('P', P)
            return P, failures
